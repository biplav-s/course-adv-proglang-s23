...
void demoClassTemplates() {
    ...
    //    * How to make it work?
    // Calculator<string> strCalc("Ten", "Twenty");

    // cout << "\n INFO: Results with strings:" << endl;
    // strCalc.displayResult();
